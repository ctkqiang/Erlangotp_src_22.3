...
const char* erts_build_flags_CFLAGS = "-Werror=undef -Werror=implicit -Werror=return-type  -fno-stack-check -fno-common -g -O2 -I/Users/johnmelody_mynapse/Downloads/otp_src_22.3/erts/x86_64-apple-darwin19.4.0    -DHAVE_CONFIG_H -Wall -Wstrict-prototypes -Wmissing-prototypes -Wdeclaration-after-statement -DUSE_THREADS -D_THREAD_SAFE -D_REENTRANT -DPOSIX_THREADS  ";
const char* erts_build_flags_CONFIG_H = "/* x86_64-apple-darwin19.4.0/config.h.  Generated from config.h.in by configure.  */\n\
...
\n\
";
const char* erts_build_flags_LDFLAGS = "-m64  -Wl,-no_weak_imports";
